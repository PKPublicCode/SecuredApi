...
public readonly struct ValidationResult
{
    ...
    public ValidationResult(ValidationStatus status, Exception? e = null)
    {
        Status = status;
        ErrorMessage = e;
    }

    public static ValidationResult MakeOk()
    {
    ...
    {
        return new ValidationResult(ValidationStatus.AccessDenied, e);
    }

    public static ValidationResult MakeNotAuthorized(Exception? e = null)
    {
        return new ValidationResult(ValidationStatus.NotAuthorized, e);
    }
}
